...
const translations = {
    es: {
        ...
        sh_oil_title: 'Cambio de Aceite', sh_oil_badge: 'Solo mano de obra • Servicio Completo',
        sh_oil_desc: 'Cambio de aceite y filtro rápido. Trae tus propios materiales o viaja sin preocupaciones con nuestro servicio todo incluido.',
        sh_oil_btn: 'Reservar Aceite',
    ...
    en: {
        ...
        sh_oil_title: 'Oil Change', sh_oil_badge: 'Labour Only • Full Service',
        sh_oil_desc: 'Quick oil and filter change. Bring your own materials or go worry-free with our all-inclusive service.',
        sh_oil_btn: 'Book Oil Change',
    ...
    ru: {
        ...
        sh_oil_title: 'Замена масла', sh_oil_badge: 'Только работа • Полный сервис',
        sh_oil_desc: 'Быстрая замена масла и фильтра. Используйте свои материалы или выберите полный сервис без забот.',
        sh_oil_btn: 'Записаться на замену',
